...
export const mockPosts: Post[] = [
  ...
  },
  {
    ...
    content:
      'リンカーンパークのWhole Foods Marketは品揃えが良く、オーガニック商品も豊富です。日本の調味料コーナーもあります。Prime会員だと割引もあるのでおすすめです。',
    summary:
      'リンカーンパークのWhole Foods Market。品揃え良し、オーガニック豊富、日本調味料あり。Prime会員割引あり。',
    type: 'post',
  ...
  },
  {
    ...
    content:
      'シカゴの有名レストランAlineaで記念日ディナー。3つ星ミシュランの革新的な料理に感動しました。予約は早めがおすすめ。ドレスコードはスマートカジュアル以上です。',
    summary:
      'Alineaでの記念日ディナー。3つ星ミシュラン、革新的料理。早めの予約必要、スマートカジュアル以上のドレスコード。',
    type: 'post',
